		...
		$con=new mysqli($host, $username, $pass, $db) or die("not connected");
			...
			if (isset($_REQUEST['Submit']))
				
				{
					...
					$_SESSION['AreaSelect']= $_POST['AreaSelect'];
					if(!empty($_SESSION['AreaSelect']))
					{
						echo "<script>location.href='AddFood3.php';</script>";
					}
					else
					{
						echo '<script language="javascript">';
						echo 'alert("Please Select Area Name")';
						echo '</script>';
					}
				...
				{
					echo "<script>location.href='AddFood1.php';</script>";
					session_unset(); 
					session_destroy();
				}
			...
			<!-- add restaurant -->
				<form method="post" target="#" >
					...
					<div class="col-md-4 center-block ">
							...
							<p align="center"><button class="btn btn-primary" name="Back" href="AddFood1.php">Back</button>

	...
	$con=new mysqli($host, $username, $pass, $db) or die("not connected");
			...
			if (isset($_REQUEST['submit']))
				
				{
					...
					$sql=  "INSERT INTO `area` (`area_name`,`city_id`) VALUES ('".$a_name."','".$cityselect."')";
			...
			<div class="container adminPanel">
					<div class="col-md-20">
						<div class="adminText">
							...
							<h4><P align="center" >Add Area</p></h4>
						</div>
					</div>
			
				<form method="post" target="#" name="1" >
					...
					<div class="row">
						...
						<P>City Name: 
								...
								<select class="form-control" id="" onchange="" name="cityselect">
									<?php
							...
							<br> <P>Area Name: <input class="form-control" type="text" name="area_name"  placeholder="Area Name"> </P></br>

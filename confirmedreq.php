				...
				<div class="row ">
					...
					<div class="col-md-6">
						<div class="">
							...
							<h4><p align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DELIVERY DONE</p><h4>
			...
			<div class="col-md-11 main-content ">
					<!--<form method="post" role="" class=""> -->
						...
						<?php
								$status="queue";
								$totalp=0;
								$sqlOrderID = "SELECT * FROM orderlist WHERE `status` = 'delivered'   ";
								...
								while($row1 = mysqli_fetch_array($result1))
								{
									...
									//echo $row1['order_id'];
									?>
									<!--<button class="btn btn-primary dropdown-toggle" onclick="myFunction(.$bbc.)" ></button> -->
									<?php
									...
									{	
										...
										//echo "<div id='".$orderid."' style='display: none;'></div>";
										 ?>
										 <div id="<?php echo $bb; ?>" value="<?php echo $bb; ?>" style="display:block">
										...
										echo '<br>';
										echo "<input name='cancel' type='hidden' value='$orderid2'><button class='btn btn-primary' type='submit'>Delete From Server</button>";
										echo "</form>";
										?>
										</div>
										<?php
